const U = globalThis, k = U.ShadowRoot && (U.ShadyCSS === void 0 || U.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = /* @__PURE__ */ Symbol(), j = /* @__PURE__ */ new WeakMap();
let Q = class {
  constructor(t, e, s) {
...
const { is: nt, defineProperty: ot, getOwnPropertyDescriptor: ht, getOwnPropertyNames: at, getOwnPropertySymbols: lt, getPrototypeOf: ct } = Object, T = globalThis, I = T.trustedTypes, dt = I ? I.emptyScript : "", pt = T.reactiveElementPolyfillSupport, S = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? dt : null;
      break;
  ...
  return e;
} }, X = (r, t) => !nt(r, t), V = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: X };
...
let g = class extends HTMLElement {
  ...
  requestUpdate(t, e, s, i = !1, n) {
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s ??= o.getPropertyOptions(t), !((s.hasChanged ?? X)(n, e) || s.useDefault && s.reflect && n === this._$Ej?.get(t) && !this.hasAttribute(o._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[S("elementProperties")] = /* @__PURE__ */ new Map(), g[S("finalized")] = /* @__PURE__ */ new Map(), pt?.({ ReactiveElement: g }), (T.reactiveElementVersions ??= []).push("2.1.2");
const L = globalThis, W = (r) => r, H = L.trustedTypes, q = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Y = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, tt = "?" + _, ut = `<${tt}>`, m = document, b = () => m.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", z = Array.isArray, $t = (r) => z(r) || typeof r?.[Symbol.iterator] == "function", N = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, J = />/g, f = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), K = /'/g, F = /"/g, et = /^(?:script|style|textarea|title)$/i, _t = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), xt = _t(1), y = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), G = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function st(r, t) {
...
const ft = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = Z : p[1] !== void 0 ? o = J : p[2] !== void 0 ? (et.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = f) : p[3] !== void 0 && (o = f) : o === f ? p[0] === ">" ? (o = i ?? E, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? f : p[3] === '"' ? F : K) : o === F || o === K ? o = f : o === Z || o === J ? o = E : (o = f, i = void 0);
    ...
    for (; (i = A.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(Y)) {
          ...
          h.push({ type: 1, index: n, name: x[2], strings: $, ctor: x[1] === "." ? mt : x[1] === "?" ? gt : x[1] === "@" ? yt : M }), i.removeAttribute(a);
...
class P {
  ...
  _$AI(t, e = this) {
    t = v(this, t, e), w(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $t(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class M {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = v(this, t, e, 0), o = !w(t) || t !== this._$AH && t !== y, o && (this._$AH = t);
      ...
      const l = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = v(this, l[s + h], e, h), c === y && (c = this._$AH[h]), o ||= !w(c) || c !== this._$AH[h], c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Et?.(C, P), (L.litHtmlVersions ??= []).push("3.3.2");
const St = (r, t, e) => {
